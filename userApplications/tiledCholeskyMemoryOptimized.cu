...
void tiledCholeskyMemoryOptimized() {
  ...
  *minusOne = -1.0;
  ...
  // Build CUDA graph with TaskManager_v2
  ...
  // =========================================================================
  // PHASE 2: OPTIMIZE MEMORY ALLOCATION
  // =========================================================================
  ...
  // Profile and optimize the graph
  fmt::print("Profiling and optimizing memory allocation...\n");
